...
def load_next_landmark(vfile, curr_frame):
    ...
    #face_points =  [1,2,3,4,49,50,51,52,34,31,30,29,28,29,30,31,34,33,32,33,34,35,36,35,34,52,53,54,55,14,15,16,17,27,26,25,24,23,22,28,23,28,29,43,44,45,47,48,43,29,40,41,42,38,39,40,29,30,31,30,29,28,22,21,20,19,18,1]
...
def change_face_main():
    ...
    while True:
       ...
       # cv2.imshow("img2_head_mask",img2_head_mask)
        ...
        #cv2.imshow("center_face2",center_face2)
    ...
    #time.sleep(3)
    command1 = "ffmpeg -i "+videosrc+"/out.mp4 -vcodec h264 -y "+videosrc+"/output.mp4"
    print(command1)
    os.system(command1)
